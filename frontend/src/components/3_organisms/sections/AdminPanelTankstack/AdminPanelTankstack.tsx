...
import { useAdminPanelStyles } from "./AdminPanelTankstackStyles";
...
export const AdminPanelTankstack = (): JSX.Element => {
  ...
  const { response: data, loading } = useGetReviews();
...
function Table({
  ...
  return (
    <div className="p-2">
                ...
                return (
                  ...
                  >
                    {header.isPlaceholder ? null : (
                      ...
                      // className={clsx(
                      //   header.column.getCanSort() && classes.header
                      // )}
                      >
                        {flexRender(
      ...
      <div>{!loading && table.getRowModel().rows.length} Rows</div>
